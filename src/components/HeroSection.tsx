  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-16 pb-8 sm:pb-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 mt-6 sm:mt-10">
          <Button variant="outline" size="lg" className="w-full sm:w-auto sm:min-w-[200px] h-12" asChild>
            <Link to="/eligibilite">Tester mon éligibilité</Link>
          </Button>
          <Button size="lg" className="w-full sm:w-auto sm:min-w-[200px] h-12 bg-primary text-primary-foreground hover:bg-primary/90" asChild>
        ...
        <p className="mt-5 sm:mt-8 text-xs sm:text-sm text-muted-foreground text-center">
          ...
          <span className="align-middle">Premier label français, 100% digital qui certifie et accompagne les entreprises</span>
        </p>
      </div>
    </section>
  );
